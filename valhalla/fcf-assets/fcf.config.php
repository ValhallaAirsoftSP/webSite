...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'equipe.valhalla@gmail.com');
define('EMAIL_TO_NAME', '');

define('EMAIL_TO_CC', '');
define('EMAIL_TO_CC_NAME', '');

define('EMAIL_TO_BCC', 'ricardo.mirao@gmail.com');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'equipe.valhalla@gmail.com');
...
define('EMAIL_SUBJECT', "Nova mensagem");
